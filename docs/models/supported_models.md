...
| `Magi2Pipeline` | MAGI-2 native Preview-stage T2VA and I2VA (272p/540p)<sup>2</sup> | `sand-ai/MAGI-2-preview` | ✅︎ | | | |
...
<sup>2</sup> MAGI-2 Preview runs through the native vLLM-Omni pipeline. It uses tensor parallel size 1 and
world-spanning Ulysses sequence parallelism on a qualified 4- or 8-GPU worker world. See the
