...
# Copyright 2026 The Microsoft Team and The HuggingFace Inc. team.
...
def _convert_original_diffusion_config(config: dict) -> dict:
...
class VibeVoiceConfig(PreTrainedConfig):
    ...
    def _normalize_original_schema(self, kwargs: dict) -> None:
